...
arrowList[1].addEventListener("click", e => {
    ...
    // e : 이벤트 객체 (모드 이벤트 관련 정보가 담겨있는 객체)
...
arrowList[2].addEventListener("click", () => {
    ...
    // 화살표 함수로
    // twoNumberPlus( (a, b) => a+b ); 익명함수로 만든 a,b를 리턴으로
    //위에있는 function twoNumberPlus(otherFn)가 참조해서 그 자리로 들어간다
    //그래서 otherFn에 twoNumberPlus의 내부의 식을 적용시켜서 값을 출력받는다

});

//return 한줄인데 object를 반환하는 경우
