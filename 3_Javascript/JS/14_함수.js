...
// #btb1 클릭 시 #input1의 값을 읽어와 print1() 함수 호출
...
document.querySelector("#btn2a").addEventListener('click', function () {
    ...
    // -> 함수 수행 후 돌아와서도
    // 참조하고 있던 배열의 2번 인덱스 값이 변화되어 있음(중요한 개념)
...
// 전달 받은 수(num) x제곱(2번쨰로 반환하는 수) 하여 반환
function pow(num, x) {
    let result = 1; // 0쓰면 곱해도 의미없으니 1로 초기화
