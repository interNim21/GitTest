...
number1 = 300; // number1에 300대입 (기본 값 10을 덮어쓰기함)
number2 = 400; 
...
number3 = 500; // 기본 변수의(number3) 새로운 값만 대입이 가능

console.log("number3 :", number3);

// 3. const(상수, constant, 항상 같은수)
// 한번 값이 대입되면 새로운 값을 대입할 수 없다

const PI =3.141592;

// PI = 1.23; (오류) 상수에 새로운 값을 대입할 수 없는데, 새로운 값이 대입되었다.
...
let undef; // 변수의 선언
console.log("undef : ", undef, tyepof undef);
...
function sumFn (a,b(2q))

console.log(typeof sumFn); // function

console.log(sumbgn=(3,5));