...
function check4() {
    ...
    if(inputAge.value.length == 0) {
        alert("미입력");
    } else { // 입력을 한 경우 -> 이 때 어린이, 청소년, 성인 검사
...
function calc(math) {
    ...
    // } else {
    //     calcResult.innerText = "요청하신 계산식이 없습니다.";
    // }
